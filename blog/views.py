...
#]
def index(request):
    blog_title= 'International Tour Packages'
...
def contact(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            success_message = 'Team will call you soon ! ... Happy journey'
            return render(request,'blog/contact.html',{'form':form, 'success_message':success_message})
        else:
             logger.debug("Form validations failure")
        return render(request,'blog/contact.html',{'form':form, 'name':name, 'email':email,'number':number, 'message':message})
...
def forgot_password(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            send_mail(subject, message, 'noreply@dkcode.com', [email])
...
@login_required
@permission_required('blog.can_published', raise_exception = True)
