...
class PostForm(forms.ModelForm):
    ...
    category = forms.ModelChoiceField(label = 'Categroy',required = True,queryset=Category.objects.all())
    ...
    def clean(self):
        ...
        if content and len(content) < 10:
            raise forms.ValidationError("Content must be at least 5 Character")
